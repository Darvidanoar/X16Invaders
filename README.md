...
For this project I am using Claude (Anthropic's AI) to write a version of Space Invaders foe the [Commander X16](https://www.commanderx16.com/) modern retro computer.
